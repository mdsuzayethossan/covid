  ...
  <tr>
    ...
    <td class="top_left" style="width: 30%">
        <table>
            ...
            <tr>
                <td class="top_left" style="width: 30%" >Invoice Number: # {{ $billing_details->first()->order_id }}<br/>
                    Invoice Date: {{ $billing_details->first()->created_at->format('d/M/y') }}<br/></td>
            </tr>
        </table>
    </td>
  </tr>
        ...
        <table>
            <tr>
                <td>
                   ...
                   {{ $billing_details->first()->address }}
                </td>

                <td class="information">
                    {{ $billing_details->first()->company }}<br /> {{ $billing_details->first()->name }}<br /> {{ $billing_details->first()->email }}
                </td>
            </tr>
        </table>
    </td>
