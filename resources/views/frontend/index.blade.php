...
@section('content')
                                    ...
                                    <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                ...
                                                <div class="actions">
                                                    ...
                                                    <a href="#" class="action quickview" data-link-action="quickview"
                                                        ...
                                                        data-bs-target="#allproduct{{ $product->id }}"><i
                                            ...
                                            <div class="content">
                                                ...
                                                <h5 class="title"><a
                                                        href="{{ route('product_details', $product->id) }}">{{ $product->product_name }}
                                                    </a>
                                                </h5>
                                                <span class="price">
                                            ...
                                            <div class="product">
                                                <div class="thumb">
                                                    <a href="single-product.html" class="image">
                                                        <img src="{{ asset('uploads/products/preview') }}/{{ $category_product->product_image }}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                                        <span class="new">New</span>
                                                    ...
                                                    <div class="actions">
                                                        ...
                                                        <a href="#" class="action quickview" data-link-action="quickview"
                                                            title="Quick view" data-bs-toggle="modal"
                                                            data-bs-target="#category_product{{ $category_product->id }}"><i
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="title"><a
                                                            href="single-product.html">{{ $category_product->product_name }}
                                                        </a>
                                                    </h5>
                                                    <span class="price">
                                                        <span
                                                            class="new">৳{{ $category_product->discount_price }}</span>
                                                        <span
                                                            class="old">৳{{ $category_product->product_price }}</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        {{-- category modal start --}}
                                        <div class="modal modal-2 fade" id="category_product{{ $category_product->id }}"
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row">
                                                            <div
                                                                ...
                                                                <div class="swiper-container zoom-top">
                                                                    <div class="swiper-wrapper">
                                                                        @foreach (App\Models\ProductThumbnails::where('product_id', $category_product->id)->get() as $product_thumb)
                                                                            <div class="swiper-slide">
                                                                                <img class="img-responsive m-auto"
                                                                                    src="{{ asset('uploads/products/thumbnails') }}/{{ $product_thumb->product_thumbnail_name }}"
                                                                                    alt="">
                                                            ...
                                                            <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up"
                                                                ...
                                                                <div class="product-details-content quickview-content">
                                                                    ...
                                                                    <div class="pricing-meta">
                                                                        <ul>
                                                                            <li class="old-price not-cut">
                                                                                ৳{{ $category_product->discount_price }}
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div class="pro-details-rating-wrap">
                                                                        ...
                                                                        <span class="read-review"><a
                                                                                class="reviews" href="#">( 5
                                                                                Customer
                                                                                Review
                                                                                )</a></span>
                                                                    </div>
                                                                    <p class="mt-30px mb-0">
                                                                        {{ $category_product->description }} </p>
                                                                    <div class="pro-details-quality">
                                                                        <div class="cart-plus-minus">
                                                                            <input class="cart-plus-minus-box" type="text"
                                                                                name="qtybutton" value="1" />
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <ul class="d-flex">
                                                                            ...
                                                                            <li>
                                                                                <a
                                                                                    href="#">{{ App\Models\Category::find($category_product->category_id)->category_name }}</a>
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                    <div
    ...
    <div class="banner-area pt-100px pb-100px plr-15px">
        <div class="row m-0">
            @foreach ($categoryForbanner as $categoryForbanner)
            ...
            <div class="row">
                ...
                <div class="col-lg-auto col-md-auto col-12">
                    <ul class="product-tab-nav nav">
                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab"
                                href="#tab-product-alll">All</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab"
            ...
            <div class="row">
                <div class="col">
                    <div class="tab-content top-borber">
                        <!-- 1st tab start -->
                        <div class="tab-pane fade show active" id="tab-product-alll">
                                        ...
                                        <div class="new-product-item swiper-slide">
                                            ...
                                            <div class="product">
                                                <div class="thumb">
                                                    <a href="{{ route('product_details', $product->id) }}"
                                                        class="image">
                                                        <img src="{{ asset('uploads/products/preview') }}/{{ $all_product->product_image }}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                                        <span class="new">New</span>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="price">
                                                        <span
                                                            class="new">৳{{ $all_product->product_price }}</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="new-product-item swiper-slide">
                                            ...
                                            <div class="product">
                                                <div class="thumb">
                                                    <a href="{{ route('product_details', $product->id) }}"
                                                        class="image">
                                                        <img src="{{ asset('uploads/products/preview') }}/{{ $latest_product->product_image }}"
                                                            alt="Product" />
                                                    </a>
                                                    <span class="badges">
                                                        <span class="new">New</span>
                                                ...
                                                <div class="content">
                                                    ...
                                                    <h5 class="title"><a
                                                            href="{{ route('product_details', $product->id) }}">{{ $latest_product->product_name }}
                                                        </a>
                                                    </h5>
                                                    <span class="price">
                                                        <span
                                                            class="new">৳{{ $latest_product->discount_price }}</span>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('frontend_assets/images/product-image/9.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('frontend_assets/images/product-image/10.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('frontend_assets/images/product-image/11.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{ asset('frontend_assets/images/product-image/8.jpg') }}"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                                    <span class="new">New</span>
