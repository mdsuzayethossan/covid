...
<head>
    ...
    <title>Fashoin eCommerce HTML Template</title>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="{{ route('index') }}"><img src="{{ asset('frontend_assets/images/logo/logo.png') }}"
                                    alt="Site Logo" /></a>
                        </div>
                    </div>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        <div class="header-actions">
                            @auth('customerlogin')
                            <a class="header-action-btn login-btn" href="{{ route('customer_profile') }}">{{ Auth::guard('customerlogin')->user()->name }}</a>
                            <div class="dropdown">
                                <button class="btn dropdown-toggle custom-dropdown" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">

                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                  <li><a class="dropdown-item custom_menu" href="{{ route('customer_singout') }}">Sing Out</a></li>
                                  <li><a class="dropdown-item custom_menu" href="{{ route('customer_profile') }}">My Account</a></li>

                                </ul>
                              </div>
                            @else
                            <a href="{{ route('customer_register') }}" class="header-action-btn login-btn">Sign In</a>
                            @endauth
                ...
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('frontend_assets/images/product-image/1.jpg') }}"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('frontend_assets/images/product-image/2.jpg') }}"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img
                                src="{{ asset('frontend_assets/images/product-image/3.jpg') }}"
                                alt="Cart product Image"></a>
                        <div class="content">
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                ...
                <ul class="minicart-product-list">
                    ...
                    <li>
                        <a href="{{ route('product_details', $cart->product_id) }}" class="image"><img
                                src="{{ asset('/uploads/products/preview') }}/{{ $cart->rel_to_product->product_image }}"
                                alt="Cart product Image"></a>
                        <div class="content">
                            <a href="{{ route('product_details', $cart->product_id) }}" class="title">{{ $cart->rel_to_product->product_name }}</a>
                            <span class="quantity-price">{{ $cart->quantity }} x <span class="amount">৳{{ $cart->rel_to_product->discount_price }}</span></span>
                            <a href="{{ route('cart_delete', $cart->id) }}"  class="remove">×</a>
                        </div>
                    </li>
                    @endforeach
